        ...
        <div class="dashboard-layout">
            ...
            <div class="dashboard-content">
                    ...
                    <table class="invoices-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button class="view-invoice-btn">View Invoice</button>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="plan-benefits-section">
                    <div class="section-title">
                        <i class="fas fa-gift"></i> Current Plan Benefits
                    </div>
                    
                    <div class="benefits-grid">
                        <div class="benefit-category">
                            <div class="category-title">Used</div>
                            <div class="benefit-item">
                                <span class="benefit-name">Active Jobs</span>
                                <span class="benefit-value">1</span>
                            </div>
                            <div class="benefit-item">
                                <span class="benefit-name">Highlight Jobs</span>
                                <span class="benefit-value">1</span>
                            </div>
                            <div class="benefit-item">
                                <span class="benefit-name">Featured Jobs</span>
                                <span class="benefit-value">1</span>
                            </div>
                            <div class="benefit-item">
                                <span class="benefit-name">Candidates Profile View</span>
                                <span class="benefit-value">3</span>
                            </div>
                        </div>
                        
                        <div class="benefit-category">
                            <div class="category-title">Remaining</div>
                            <div class="benefit-item">
                                <span class="benefit-name">Active Jobs</span>
                            ...
                            <div class="benefit-item">
                                <span class="benefit-name">Featured Jobs</span>
                                <span class="benefit-value">9</span>
                            </div>
                            <div class="benefit-item">
                                <span class="benefit-name">Candidates Profile View</span>
                                <span class="benefit-value">18</span>
                ...
                <div class="chat-section">
                    ...
                    <div class="chat-description">Have questions about plans or billing? Our team is here to help you.</div>
